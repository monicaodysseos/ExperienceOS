    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('participant', 'Participant'), ('provider', 'Provider'), ('both', 'Both'), ('admin', 'Admin')], default='participant', max_length=20)),
                ...
                ('gdpr_accepted_at', models.DateTimeField(blank=True, null=True)),
