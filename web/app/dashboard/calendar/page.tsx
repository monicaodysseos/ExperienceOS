  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-display text-4xl font-bold text-navy-900 ">Events Calendar</h1>
        ...
        <div className="space-y-6">
          {selectedSlot ? (
            <div className="rounded-[2.5rem] border-4 border-navy-900 bg-purple-400 p-8 shadow-playful blob-shape-3 relative">
              <h3 className="font-display text-2xl font-bold text-navy-900 line-clamp-2  relative z-10">
