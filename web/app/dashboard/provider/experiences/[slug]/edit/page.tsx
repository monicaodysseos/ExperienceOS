...
function EditExperienceContent() {
  ...
  if (loadError) {
    return (
      <div className="mx-auto max-w-2xl">
        <Link href="/dashboard/provider/experiences" className="mb-6 flex items-center gap-2 text-sm text-navy-500 hover:text-navy-700">
        ...
        <div className="rounded-xl border-2 border-red-200 bg-red-50 p-8 text-center">
          <h2 className="text-xl font-bold text-red-900">Failed to Load Experience</h2>
          <p className="mt-2 text-sm text-red-700">{loadError}</p>
          <Button className="mt-4" variant="outline" onClick={() => router.push("/dashboard/provider/experiences")}>
            Back to Experiences
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-navy-900">Edit Experience</h1>
